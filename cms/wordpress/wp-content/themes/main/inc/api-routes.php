...
add_action( 'rest_api_init', function () {
	...
	// Register routes
	register_rest_route( 'example-website/v1', '/post', array(
		'methods'  => 'GET',
	...
	register_rest_route( 'example-website/v1', '/page', array(
		'methods'  => 'GET',
	...
	register_rest_route('example-website/v1', '/post/preview', array(
		'methods'  => 'GET',
